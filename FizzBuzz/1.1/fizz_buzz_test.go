...
func TestIsFizz(t *testing.T) {
	...
	t.Run("should be return false when input 4", func(t *testing.T) {
		input := 4
		want := false
...
func TestIsBuzz(t *testing.T) {
	t.Run("should be return true when input 5", func(t *testing.T) {
		input := 5
		want := true
	...
	t.Run("should be return false when input 7", func(t *testing.T) {
		input := 7
		want := false
